...
object HigherOrder {
   ...
   */
  def nTimes(f: (Int, Int) => Int, a: Int, b: Int, n: Int): Int = { return n * f(a, b) }
   ...
   *          if (a > b) a else b
   */
  val fmax:(Int, Int) => Int = { (a, b) => if (a > b) a else b }

  def testAnonymousNTimes(a: Int, b: Int, n: Int): Int = nTimes(fmax,a, b, n)
}
